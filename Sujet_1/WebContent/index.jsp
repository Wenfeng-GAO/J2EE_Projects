...
<div class="container">
	...
	Le site devra être développé en java JEE avec l’utilisation de HTML 5 et de CSS 3. Il devra s'exécuter sur un serveur tomcat 7 (au mieux tomcat 8) et la base de données sera géré via un serveur mysql sous wamp.
		</p>
